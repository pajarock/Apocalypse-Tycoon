...
local CRIT_COLOR = Color3.fromRGB(255, 220, 80) -- Dorado mÃÂ¡s vibrante
local CRIT_THRESHOLD = 50 -- DaÃÂ±o crÃÂ­tico
...
game.ReplicatedStorage.Remotes.BaseDamaged.OnClientEvent:Connect(function(damage)
	...
	-- Texto principal con estilo segÃÂºn daÃÂ±o
	...
	-- Estilo grafiti para crÃÂ­ticos
	if isCrit then
		label.Font = Enum.Font.LuckiestGuy -- GRAFITI
		label.Text = "-" .. tostring(damage) .. "!"
		label.TextColor3 = CRIT_COLOR
		label.TextStrokeTransparency = 0.1 -- Borde mÃÂ¡s fuerte
		label.TextStrokeColor3 = Color3.fromRGB(100, 50, 0)
		label.Rotation = math.random(-8, 8) -- RotaciÃÂ³n random grafiti
	else
	...
	-- Efecto inicial - bounce mÃÂ¡s dramÃÂ¡tico para crits
	...
	-- Efecto extra para crÃÂ­ticos: flash dorado
	if isCrit then
