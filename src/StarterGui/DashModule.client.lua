...
-- ✅ FIX: Inicializar con nil y esperar en pcall para evitar errores
...
local function createDashTrail()
	-- ✅ FIX: Validar que rootPart existe
	if not rootPart or not rootPart.Parent then
		warn("[DashModule] ⚠️ RootPart no disponible para trail")
		return
	end
...
local function performDash()
	...
	if DashRemote and humanoid and humanoid.Parent then
