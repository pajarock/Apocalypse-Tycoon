...
waveFrame.Size = UDim2.fromOffset(250, 70)
waveFrame.Position = UDim2.new(0, 45, 0, 10)
...
moneyFrame.Size = UDim2.fromScale(0.3, 0.10) -- Media pantalla ancho, 15% alto
moneyFrame.Position = UDim2.new(0.025, 0.66, 0.85, 0) -- Derecha, arriba
...
if currentWaveValue and currentWaveValue:IsA("IntValue") then
	...
	warn("[UI] ?? No se encontró CurrentWave")
end
