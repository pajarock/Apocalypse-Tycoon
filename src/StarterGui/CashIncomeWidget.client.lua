...
sg.DisplayOrder = 10 -- ? FIX: Evitar superposiciÃÂ³n con otros widgets
...
frame.Rotation = -1.5 -- RotaciÃÂ³n sutil estilo urbano
frame.Parent = sg
...
cashLabel.TextColor3 = Color3.fromRGB(100, 255, 140) -- Verde neÃÂ³n
cashLabel.TextXAlignment = Enum.TextXAlignment.Left
cashLabel.Text = "?? $0"
cashLabel.TextStrokeTransparency = 0.3
cashLabel.TextStrokeColor3 = Color3.fromRGB(0, 50, 0)
cashLabel.ZIndex = 2
cashLabel.Rotation = -1 -- InclinaciÃÂ³n grafiti
...
incomeLabel.Rotation = -1 -- InclinaciÃÂ³n grafiti
...
-- FunciÃÂ³n para formatear dinero
...
-- AnimaciÃÂ³n de pulso cuando cambia el dinero
local lastCash = 0
local lastIncome = 0
local displayedIncome = 0 -- Para animaciÃÂ³n de contador
...
-- ?? AnimaciÃÂ³n de nÃÂºmeros subiendo rÃÂ¡pidamente
...
-- Loop de actualizaciÃÂ³n (cada 0.5 segundos para mÃÂ¡s responsividad)
task.spawn(function()
	while true do
		update()
		task.wait(0.5)
...
print("[CashIncomeWidget] ? Widget unificado inicializado con estilo grafiti + detecciÃÂ³n IncomeBoost")