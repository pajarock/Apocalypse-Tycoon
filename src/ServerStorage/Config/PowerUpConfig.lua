...
--[[
	...
	ConfiguraciÃÂ³n completa de todos los powerups del juego.

	TIPOS DE POWERUPS:
	- Basic: Escudo, Doble DaÃÂ±o, Full Heal, Velocidad
	- Movement: Dash mejorado
	- Defensive: Dron, Escudo de Base, Meteor Jammer, ExplosiÃÂ³n
...
-- -----------------------------------------------------------------------
-- ?? MÃÂQUINA EXPENDEDORA DE POWERUPS
-- -----------------------------------------------------------------------

PowerUpConfig.VendingMachine = {
	-- Costo inicial de la mÃÂ¡quina (comprar el edificio)
	PurchaseCost = 500,
	...
	-- Drop rates para la mÃÂ¡quina (mÃÂ¡s balanceados que waves)
	DropRates = {
		Common = 50,    -- 50%
		Uncommon = 35,  -- 35%
		Rare = 13,      -- 13%
...
PowerUpConfig.SpawnChances = {
	...
	Normal = {
		Common = 60,    -- 60% chance powerup comÃÂºn
		Uncommon = 30,  -- 30% chance powerup poco comÃÂºn
...
PowerUpConfig.PowerUps = {
	...
	GodShield = {
		...
		Rarity = "Common",
		Duration = {Min = 5, Max = 10}, -- DuraciÃÂ³n aleatoria entre 5-10 seg

		Icon = "???",
		Color = Color3.fromRGB(100, 200, 255), -- Azul/verde tÃÂ³xico
		...
		-- FunciÃÂ³n de activaciÃÂ³n (se llama en PowerUpModule)
		OnActivate = "ActivateGodShield",
	},

	-- ???????????????????????????????????????????????????????????????
	-- 2. DOUBLE DAMAGE (Doble DaÃÂ±o)
	-- ???????????????????????????????????????????????????????????????
	DoubleDamage = {
		Name = "Double Damage",
		Description = "10-15 seg de daÃÂ±o x2 (ideal para mini-boss)",
		Rarity = "Common",
	...
	-- ???????????????????????????????????????????????????????????????
	-- 3. DASH MEJORADO (EvasiÃÂ³n Perfecta)
	-- ???????????????????????????????????????????????????????????????
	SuperDash = {
		Name = "Super Dash",
	...
	-- ???????????????????????????????????????????????????????????????
	-- 4. FULL HEAL (CuraciÃÂ³n InstantÃÂ¡nea)
	-- ???????????????????????????????????????????????????????????????
	FullHeal = {
		Name = "Full Heal",
		Description = "Restaura 100% HP instantÃÂ¡neamente",
		Rarity = "Common",
		Duration = 0, -- InstantÃÂ¡neo
	...
	-- ???????????????????????????????????????????????????????????????
	-- 5. MINI DRON (Defensa AutomÃÂ¡tica)
	-- ???????????????????????????????????????????????????????????????
	MiniDrone = {
		Name = "Mini Drone",
	...
	-- ???????????????????????????????????????????????????????????????
	-- 9. DEFENSIVE BURST (ExplosiÃÂ³n Defensiva)
	-- ???????????????????????????????????????????????????????????????
	DefensiveBurst = {
		Name = "Defensive Burst",
		Description = "ExplosiÃÂ³n que limpia meteoritos cercanos",
		Rarity = "Uncommon",
		Duration = 0, -- InstantÃÂ¡neo
	...
	CriticalParry = {
		Name = "Critical Parry",
		Description = "Convierte el prÃÂ³ximo impacto en explosiÃÂ³n que daÃÂ±a meteoritos cercanos",
		Rarity = "Rare",
		Duration = 0, -- Hasta que se use
...
-- Obtener powerup aleatorio segÃÂºn rarity
