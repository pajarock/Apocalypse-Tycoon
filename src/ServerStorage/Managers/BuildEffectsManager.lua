...
--[[
	...
	Maneja animaciones y efectos visuales durante la construcciÃ³n de upgrades.

	FEATURES:
	? Fade in + Scale from 0 ? 1
	? PartÃ­culas de construcciÃ³n (chispas, humo)
	? Sonidos de construcciÃ³n
	? Ghost preview (transparente)
	? Billboard temporal "CONSTRUIDO"
	? IntegraciÃ³n con VFXManager
	...
	API:
		:PlayBuildEffect(model, duration) - AnimaciÃ³n completa
...
--[[
	...
	@param position Vector3 - PosiciÃ³n donde mostrar
	@param text string - Texto a mostrar
	@param duration number? - DuraciÃ³n en segundos (default: 2)
]]
...
--[[
	Reproduce el efecto completo de construcciÃ³n.

	@param model Model - El modelo que se estÃ¡ construyendo
	@param duration number? - DuraciÃ³n total (default: 1.0)
]]
...
--[[
	VersiÃ³n simplificada solo con fade (sin scale, para performance).

	@param model Model - El modelo
	@param duration number? - DuraciÃ³n (default: 0.5)
]]
...
--[[
	Efecto de "deconstrucciÃ³n" (al vender).
