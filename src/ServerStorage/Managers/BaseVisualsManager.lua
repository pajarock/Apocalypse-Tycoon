...
--[[
	...
	Maneja efectos visuales dinÃÂ¡micos de las bases segÃÂºn su HP.

	FEATURES:
	? Efectos progresivos segÃÂºn HP (100% ? 0%)
	? Humo cuando HP < 50%
	? Fuego cuando HP < 25%
	? Grietas y daÃÂ±o visual
	...
	USAGE:
		...
		-- Actualizar efectos segÃÂºn HP
...
--[[
	...
	@param position Vector3 - PosiciÃÂ³n donde spawnear
	@param playerName string - Nombre del jugador
	@param baseSize Vector3? - TamaÃÂ±o de la base (opcional)
...
--[[
	Actualiza los efectos visuales segÃÂºn el HP actual.

	@param userId number - ID del jugador
	@param currentHP number - HP actual
	@param maxHP number - HP mÃÂ¡ximo
]]
...
function BaseVisualsManager:CleanupBase(userId: number)
	...
	-- Base se limpia automÃÂ¡ticamente al remover jugador
	BaseData[userId] = nil
