...
--[[
	...
	FEATURES:
	? Object pooling automÃÂ¡tico (mÃÂ¡x 50 por tipo)
	? Auto-cleanup despuÃÂ©s de duraciÃÂ³n del efecto
	...
	- Auto-retorna efectos al pool despuÃÂ©s de Duration
	- MÃÂ¡ximo 50 instancias por tipo de efecto
	- Cleanup automÃÂ¡tico de efectos viejos
]]
...
--[[
	Spawnea un efecto visual en una posiciÃÂ³n.

	@param effectName string - Nombre del efecto (debe existir en VFXConfig)
	@param position Vector3 - PosiciÃÂ³n 3D donde spawnear el efecto
...
--[[
	Obtiene estadÃÂ­sticas del pool de efectos.
...
--[[
	Limpia el pool de un efecto especÃÂ­fico o todos.
...
print("[VFXManager] ? MÃÂ³dulo cargado con object pooling")
