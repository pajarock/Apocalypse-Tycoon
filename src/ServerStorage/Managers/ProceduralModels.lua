...
-- -----------------------------------------------------------------------
-- ?? POWERUP VENDING MACHINE (MÃÂ¡quina Expendedora de PowerUps)
-- -----------------------------------------------------------------------
local function createPowerUpVendingMachine(): Model
	...
	-- PowerUp visual dentro de la esfera (pequeÃÂ±a esfera brillante)
	...
	-- BotÃÂ³n de compra (grande y obvio)
	...
	addPulseAnimation(button, 0.15, 1.2) -- Pulsar el botÃÂ³n para llamar atenciÃÂ³n
