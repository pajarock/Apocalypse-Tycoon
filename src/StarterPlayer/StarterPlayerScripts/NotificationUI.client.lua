...
local NOTIFICATION_START_POSITION = UDim2.new(1, -140, 0, 120) -- ✅ FIX: Esquina superior-derecha (toasts pequeños)
...
local function createNotification(message: string, duration: number, color: Color3?): Frame
	...
	frame.AnchorPoint = Vector2.new(1, 0) -- ✅ FIX: Anclar desde esquina superior-derecha
