...
--[[
	...
	- Y: Reset a Wave 1
	- 1-9: Saltar a wave especÃÂ­fico (x10): 10, 20, 30... 90
	- 0: Saltar a wave 100

	BOSS/MINI-BOSS:
	- B: Spawn Boss instantÃÂ¡neo (4 fases completas)
	- V: Spawn Mini-Boss instantÃÂ¡neo (1 fase aleatoria)
	...
	SUPERVIVENCIA:
	- J: Toggle Invencibilidad (no recibes daÃÂ±o)
...
local function createHelpUI()
	...
	local commands = {
		...
		{section = "ECONOMÃÂA", color = Color3.fromRGB(100, 255, 100)},
		{key = "C", desc = "AÃÂ±adir $10,000"},
		{key = "Shift+C", desc = "AÃÂ±adir $100,000"},
...
UIS.InputBegan:Connect(function(input, gameProcessed)
	...
	elseif input.KeyCode == Enum.KeyCode.H then
		...
		-- SALTAR A WAVE ESPECÃÂFICO (1-9, 0)
	...
	elseif input.KeyCode == Enum.KeyCode.J then
		...
		-- El feedback se mostrarÃÂ¡ cuando el servidor confirme el cambio
	end
end)
