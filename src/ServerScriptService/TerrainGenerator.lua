--!strict
--[[
	TERRAIN GENERATOR - Apocalypse Tycoon (VERSIÃÂN CORREGIDA)
	Genera un mapa apocalÃÂ­ptico prehispÃÂ¡nico con lava y montaÃÂ±as
]]
...
local function createLavaOcean(mapFolder: Folder)
	...
	print("[TERRAIN] OcÃÂ©ano de lava creado")
end
...
local function setupLighting()
	...
	print("[TERRAIN] IluminaciÃÂ³n configurada")
end
...
function TerrainGenerator.GenerateMap(): Folder
	...
	print("[TERRAIN] Iniciando generaciÃÂ³n del mapa...")

	createLavaOcean(mapFolder)

	print("[TERRAIN] Generando montaÃÂ±as...")
