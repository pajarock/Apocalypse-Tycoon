--!strict
--[[
	AMBIENT EFFECTS - Apocalypse Tycoon (VERSIÃN CORREGIDA)
...
local function createGroundFog()
	...
	print("[EFFECTS] Niebla tÃ³xica creada")
end
...
local function createLightning()
	...
	print("[EFFECTS] Sistema de relÃ¡mpagos iniciado")
end
...
local function createFloatingCrystals()
	...
	print("[EFFECTS] Cristales mÃ­sticos creados")
end
