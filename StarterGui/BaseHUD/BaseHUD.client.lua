...
local function updateRepairButton()
	...
	-- ✅ ARREGLADO: Calcular costo EXACTAMENTE igual que en servidor
	...
	-- Usar EXACTAMENTE la misma fórmula que Main.Server.lua línea 929-933
	local baseCost = 50  -- Config.REPAIR_COST_PER_HP (valor por defecto)
