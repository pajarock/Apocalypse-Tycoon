...
local function updateRepairButton()
	...
	-- ✅ FIX: Calcular costo igual que en servidor (Main.Server.lua:929-933)
	...
	local baseCost = 10  -- Config.REPAIR_COST_PER_HP
...
BaseStateChanged.OnClientEvent:Connect(function()
	update()
	updateRepairButton() -- ✅ FIX: También actualizar botón de reparar
end)

task.spawn(function()
	while true do
		update()
		updateRepairButton() -- ✅ FIX: Actualizar botón cada 2s
		task.wait(2)
	end
end)
